...
function Counter() {
  ...
  return (
    <>
      <h1 className='text-light fw-bolder text-center mt-5'>Counter-Application</h1>
...
<button className="btn btn-secondary ms-3" onClick={handleIncrement}>Increment Amount</button>
</div>
      </div>
